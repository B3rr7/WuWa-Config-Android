...
object CvarDatabase {
    ...
    private fun ensureLoaded() {
        ...
        LogRepository.add("CvarDatabase: loaded ${_allCvars!!.size} CVars, ${_monitoredCvars!!.size} monitored, ${_defaultValues!!.size} defaults", LogLevel.SUCCESS)
    }
    ...
    private val topLevelRules = listOf(
    ...
    private val rSubRules = listOf(
        ...
        CatRule("r.md cfallback.", CvarCategory.LOD_CULLING),
    ...
    private val mobileSubExceptions = setOf(
    ...
    fun categorize(key: String): CvarCategory {
        ...
        if (k.startsWith("r.") && k.length > 2) {
            ...
            if (!subKey.startsWith("mobile.")) {
                ...
                val lightShadowPrefixes = listOf("ssr", "waterssr", "sceneobjmobilessr", "pixelprojectedreflectionquality",
