...
class ConfigGenerator(private val cvarDatabase: CvarDatabase) {
    ...
    ): String = com.wuwaconfig.app.config.replaceCoreSystemPaths(engineIni, corePaths)

    fun extractCoreSystemPaths(engineIni: String?): List<String> = com.wuwaconfig.app.config.extractCoreSystemPaths(engineIni, DEFAULT_CORE_SYSTEM)
    ...
    ): String = com.wuwaconfig.app.config.applyCvarOverrides(text, overrides)
}
