...
object GamePaths {
    ...
    const val UE4_COMMAND_LINE_REL_PATH = "files/UE4Game/Client/UE4CommandLine.txt"
    ...
    val UE4_COMMAND_LINE_PATH = "/storage/emulated/0/Android/data/$TARGET_PACKAGE/$UE4_COMMAND_LINE_REL_PATH"
